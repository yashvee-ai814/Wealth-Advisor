...
def calculate_monthly_savings_needed(
    ...
    n = years
    growth_factor = (1 + r) ** n
    future_value_of_current = current_pot * growth_factor
    remaining = target_pot - future_value_of_current
...
def calculate_readiness_score(
    ...
    result = ReadinessScoreOutput(score=score, label=label)
    return result.model_dump()
...
def calculate_inflation_adjusted_goal(
    ...
    result = InflationAdjustedGoalOutput(
